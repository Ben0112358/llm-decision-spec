...
@pytest.mark.parametrize(
    ...
    [
        # OR
        ("+", True,  True,  [{"id": 1}], [{"id": 2}], True,  [{"id": 1}, {"id": 2}]),
        ("+", True,  False, [{"id": 1}], [{"id": 2}], True,  [{"id": 1}, {"id": 2}]),
        ("+", False, True,  [{"id": 1}], [{"id": 2}], True,  [{"id": 1}, {"id": 2}]),
        ("+", False, False, [{"id": 1}], [{"id": 2}], False, [{"id": 1}, {"id": 2}]),

        # AND
        ("*", True,  True,  [{"id": 1}], [{"id": 2}], True,  [{"id": 1}, {"id": 2}]),
        ("*", True,  False, [{"id": 1}], [{"id": 2}], False, [{"id": 1}, {"id": 2}]),
        ("*", False, True,  [{"id": 1}], [{"id": 2}], False, [{"id": 1}, {"id": 2}]),
        ("*", False, False, [{"id": 1}], [{"id": 2}], False, [{"id": 1}, {"id": 2}]),

        # And(Not())
        ("-", True,  True,  [{"id": 1}], [{"id": 2}], False, [{"id": 1}, {"id": 2}]),
        ("-", True,  False, [{"id": 1}], [{"id": 2}], True,  [{"id": 1}, {"id": 2}]),
        ("-", False, True,  [{"id": 1}], [{"id": 2}], False, [{"id": 1}, {"id": 2}]),
        ("-", False, False, [{"id": 1}], [{"id": 2}], False, [{"id": 1}, {"id": 2}]),
    ]
